...
class DBconnector:
    ...
    def fetch_qctable(self,):
        ...
        data_dict = {
            ...
            'OCV_ADG':float,                                 
            'OVC_EOL':float,                                 
            'Date_BWT':pd.to_datetime,                                 
            'Date_AWT':pd.to_datetime,                                 
            'Date_AXL':pd.to_datetime,                                 
            'Date_AFM':pd.to_datetime,                                 
            'Date_ADG':pd.to_datetime,                                 
            'Date_EOL':pd.to_datetime,                                 
            'Cell_ID_Vicarli':str,                          
            'Grindometer':str,                              
            'Rheology':str,                                 
            'Solid_content':str,                           
            ...
            'Date_of_stacking':pd.to_datetime,                          
            'Insulation_test':str,                          
